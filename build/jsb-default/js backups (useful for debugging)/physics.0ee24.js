...
if (t || i) {
this.body.aabbNeedsUpdate = !0;
p.copy(this.body.position, e.__wpos);
u.copy(this.body.quaternion, e.__wrot);
if (e._localMatDirty & c) {
...
(0, s.updateWorldRT)(this.node, y, f);
}
};
e.destroy = function() {
...
var c = cc.Vec3, u = new c(), p = function(t) {
h(e, t);
l(e, [ {
key: "boxCollider",
get: function() {
...
c.multiplyScalar(i.halfExtent, e, .5);
...
c.multiplyScalar(this.halfExtent, t, .5);
c.multiply(this.box.halfExtents, this.halfExtent, u);
...
var c = new cc.Vec3(), u = function(t) {
h(e, t);
l(e, [ {
key: "sphereCollider",
get: function() {
...
var f = cc._decorator, v = f.ccclass, m = f.property, g = cc.js.array.fastRemove, w = cc.math.equals, b = v("cc.PhysicsMaterial")(o = (n = (l = a = function(t) {
d(e, t);
p(e, [ {
key: "friction",
get: function() {
...
function e() {
var i;
h(i = t.call(this) || this, "_friction", r, c(i));
h(i, "_restitution", s, c(i));
cc.EventTarget.call(c(i));
e.allMaterials.push(c(i));
...
return e;
}(cc.Asset), a.allMaterials = [], a._idCounter = 0, l), r = y(n.prototype, "_friction", [ m ], {
configurable: !0,
enumerable: !0,
writable: !0,
...
var g = cc._decorator, w = g.ccclass, b = g.executeInEditMode, x = g.executionOrder, _ = g.menu, B = g.property, S = cc.Vec3, E = (o = w("cc.BoxCollider3D"), 
n = x(98), r = _("i18n:MAIN_MENU.component.physics/Collider/Box 3D"), s = B({
type: cc.Vec3
}), o(a = n(a = r(a = b(a = (m((l = function(t) {
v(e, t);
f(e, [ {
key: "size",
get: function() {
...
function e() {
var e;
p(e = t.call(this) || this, "_size", h, d(e));
...
var b = cc._decorator, x = b.ccclass, _ = b.property, B = cc.Vec3, S = (o = x("cc.Collider3D"), 
n = _({
...
function e() {
var e;
(e = t.call(this) || this)._isSharedMaterial = !0;
y(e, "_material", c, f(e));
y(e, "_isTrigger", u, f(e));
y(e, "_center", p, f(e));
cc.EventTarget.call(f(e));
return e;
}
var i = e.prototype;
i.on = function() {};
...
var y = cc._decorator, f = y.ccclass, v = y.executeInEditMode, m = y.executionOrder, g = y.menu, w = y.property, b = f("cc.SphereCollider3D")(o = m(98)(o = g("i18n:MAIN_MENU.component.physics/Collider/Sphere 3D")(o = v(o = (d((n = function(t) {
p(e, t);
u(e, [ {
key: "radius",
get: function() {
...
function e() {
var e;
l(e = t.call(this) || this, "_radius", r, h(e));
...
var S = cc._decorator, E = S.ccclass, M = S.executeInEditMode, C = S.executionOrder, A = S.menu, z = S.property, F = S.requireComponent, T = S.disallowMultiple, R = cc.Vec3, P = (o = E("cc.ConstantForce"), 
n = C(98), r = F(m.RigidBody3D), s = A("i18n:MAIN_MENU.component.physics/Constant Force 3D"), 
a = z({
displayOrder: 0
}), l = z({
displayOrder: 1
...
displayOrder: 3
}), o(u = n(u = r(u = s(u = T(u = M(u = (p = function(t) {
_(e, t);
function e() {
...
return e;
}(cc.Component), d = B(p.prototype, "_force", [ z ], {
configurable: !0,
enumerable: !0,
writable: !0,
initializer: function() {
...
}), v = B(p.prototype, "_localTorque", [ z ], {
configurable: !0,
enumerable: !0,
writable: !0,
initializer: function() {
...
}), B(p.prototype, "force", [ a ], Object.getOwnPropertyDescriptor(p.prototype, "force"), p.prototype), 
B(p.prototype, "localForce", [ l ], Object.getOwnPropertyDescriptor(p.prototype, "localForce"), p.prototype), 
B(p.prototype, "torque", [ h ], Object.getOwnPropertyDescriptor(p.prototype, "torque"), p.prototype), 
B(p.prototype, "localTorque", [ c ], Object.getOwnPropertyDescriptor(p.prototype, "localTorque"), p.prototype), 
p)) || u) || u) || u) || u) || u) || u);
i.ConstantForce = P;
}, {
...
var T = cc._decorator, R = T.ccclass, P = T.disallowMultiple, q = T.executeInEditMode, I = T.executionOrder, V = T.menu, O = T.property, k = cc.Vec3, N = (o = R("cc.RigidBody3D"), 
n = I(99), r = V("i18n:MAIN_MENU.component.physics/Rigid Body 3D"), s = O({
displayOrder: 0
}), a = O({
displayOrder: 1
}), l = O({
...
displayOrder: 7
}), o(y = n(y = r(y = q(y = P(y = (F((f = function(t) {
z(e, t);
A(e, [ {
key: "allowSleep",
get: function() {
...
function e() {
var e;
(e = t.call(this) || this)._allowSleep = !0;
E(e, "_mass", v, M(e));
E(e, "_linearDamping", m, M(e));
E(e, "_angularDamping", g, M(e));
E(e, "_fixedRotation", w, M(e));
E(e, "_isKinematic", b, M(e));
E(e, "_useGravity", x, M(e));
E(e, "_linearFactor", _, M(e));
E(e, "_angularFactor", B, M(e));
...
F(f.prototype, "isKinematic", [ h ], Object.getOwnPropertyDescriptor(f.prototype, "isKinematic"), f.prototype), 
F(f.prototype, "useGravity", [ c ], Object.getOwnPropertyDescriptor(f.prototype, "useGravity"), f.prototype), 
F(f.prototype, "fixedRotation", [ u ], Object.getOwnPropertyDescriptor(f.prototype, "fixedRotation"), f.prototype), 
F(f.prototype, "linearFactor", [ p ], Object.getOwnPropertyDescriptor(f.prototype, "linearFactor"), f.prototype), 
F(f.prototype, "angularFactor", [ d ], Object.getOwnPropertyDescriptor(f.prototype, "angularFactor"), f.prototype), 
v = F(f.prototype, "_mass", [ O ], {
configurable: !0,
enumerable: !0,
writable: !0,
initializer: function() {
...
}), m = F(f.prototype, "_linearDamping", [ O ], {
configurable: !0,
enumerable: !0,
writable: !0,
initializer: function() {
...
}), g = F(f.prototype, "_angularDamping", [ O ], {
configurable: !0,
enumerable: !0,
writable: !0,
initializer: function() {
...
}), w = F(f.prototype, "_fixedRotation", [ O ], {
configurable: !0,
enumerable: !0,
writable: !0,
initializer: function() {
...
}), b = F(f.prototype, "_isKinematic", [ O ], {
configurable: !0,
enumerable: !0,
writable: !0,
initializer: function() {
...
}), _ = F(f.prototype, "_linearFactor", [ O ], {
configurable: !0,
enumerable: !0,
writable: !0,
initializer: function() {
...
}), B = F(f.prototype, "_angularFactor", [ O ], {
configurable: !0,
enumerable: !0,
writable: !0,
initializer: function() {
...
var g = cc._decorator, w = g.property, b = (0, g.ccclass)("cc.Physics3DManager")(o = (r = m((n = function() {
v(t, [ {
key: "enabled",
get: function() {
...
cc.Mat3), l = cc.Mat4, h = cc.Vec3, c = cc.Quat, u = cc.Trs, p = [], d = cc.v3(), y = cc.quat(), f = new a(), v = f.m, m = cc.quat(), g = cc.mat4(), w = {};
function b(t, e) {
void 0 === e && (e = !1);
for (var i, o, r, s, g, b, x, _, B = t, S = 0, E = !1, M = 0; B; ) {
if (!e && w[B._id]) {
...
keywords: [ "cannon.js", "cocos", "creator", "physics.0ee24", "engine", "3d" ],
scripts: {
...
for (var o = t.numObjects(), r = t.bodies, a = this.aabbMax, l = this.aabbMin, h = this.nx, c = this.ny, u = this.nz, p = c * u, d = u, y = 1, f = a.x, v = a.y, m = a.z, g = l.x, w = l.y, b = l.z, x = h / (f - g), _ = c / (v - w), B = u / (m - b), S = (f - g) / h, E = (v - w) / c, M = (m - b) / u, C = .5 * Math.sqrt(S * S + E * E + M * M), A = n.types, z = A.SPHERE, F = A.PLANE, T = (A.BOX, 
A.COMPOUND, A.CONVEXPOLYHEDRON, this.bins), R = this.binLengths, P = this.bins.length, q = 0; q !== P; q++) R[q] = 0;
var I = Math.ceil;
...
V(it.aabb.lowerBound.x, it.aabb.lowerBound.y, it.aabb.lowerBound.z, it.aabb.upperBound.x, it.aabb.upperBound.y, it.aabb.upperBound.z, it);
}
}
for (q = 0; q !== P; q++) {
var tt = R[q];
...
i.vsub(e, u);
t.vsub(e, p);
var n, r, s = V.dot(V), a = V.dot(u), l = V.dot(p), h = u.dot(u), c = u.dot(p);
...
for (var s = M, a = C, l = r && r.faceList || null, h = t.faces, c = t.vertices, u = t.faceNormals, p = this._direction, y = this.from, f = this.to, b = y.distanceTo(f), x = l ? l.length : h.length, _ = this.result, B = 0; !_._shouldStop && B < x; B++) {
...
var a = A, l = q, h = I, c = C, u = z, p = F, y = T, f = P, b = R, x = (s && s.faceList, 
...
t.getVertex(x[3 * O], m);
m.vsub(p, c);
var k = u.dot(a), N = a.dot(c) / k;
if (!(N < 0)) {
u.scale(N, v);
v.vadd(p, v);
t.getVertex(x[3 * O + 1], g);
t.getVertex(x[3 * O + 2], w);
var j = v.distanceSquared(p);
if (!(!d(v, g, m, w) && !d(v, m, g, w) || j > E)) {
n.vectorToWorldFrame(e, a, b);
...
var w = -1 / v;
t.suspensionRelativeVelocity = g * w;
...
var t = this.stiffness, e = this.damping, i = this.restLength, o = this.bodyA, f = this.bodyB, v = n, m = r, g = s, w = a, b = y, x = l, _ = h, B = c, S = u, E = p, M = d;
...
f.angularVelocity.cross(S, b);
g.vadd(b, g);
o.angularVelocity.cross(B, b);
g.vsub(b, g);
m.mult(-t * (C - i) - e * g.dot(m), w);
o.force.vsub(w, o.force);
f.force.vadd(w, f.force);
B.cross(w, E);
S.cross(w, M);
...
var l = c, h = u, v = p, m = d, g = y, w = f, b = Number.MAX_VALUE;
...
for (var a = b, l = x, h = _, c = B, u = S, p = E, d = M, y = C, f = o, v = [], m = -1, g = Number.MAX_VALUE, w = 0; w < this.faces.length; w++) {
a.copy(this.faceNormals[w]);
i.vmult(a, a);
var A = a.dot(t);
if (A < g) {
g = A;
...
var z = this.faces[m];
z.connectedFaces = [];
for (var F = 0; F < this.faces.length; F++) for (var T = 0; T < this.faces[F].length; T++) -1 !== z.indexOf(this.faces[F][T]) && F !== m && -1 === z.connectedFaces.indexOf(F) && z.connectedFaces.push(F);
f.length;
...
i.vmult(y, y);
var k = O - y.dot(e);
this.clipFaceAgainstPlane(f, v, y, k);
for (;f.length; ) f.shift();
for (;v.length; ) f.push(v.shift());
}
d.copy(this.faceNormals[m]);
O = this.getPlaneConstantOfFace(m);
y.copy(d);
i.vmult(y, y);
for (k = O - y.dot(e), F = 0; F < f.length; F++) {
var N = y.dot(f[F]) + k;
N <= n && (N = n);
if (N <= r) {
var j = f[F];
...
var s = t.vertices.length, a = R, l = 0, h = 0, c = P, u = t.vertices;
c.setZero();
...
var b = [], x = (v = [], []), _ = [], B = [];
h = n.cos, c = n.sin;
b.push(new i(e * h(0), e * c(0), .5 * -r));
_.push(0);
b.push(new i(t * h(0), t * c(0), .5 * r));
B.push(1);
for (g = 0; g < l; g++) {
m = 2 * Math.PI / l * (g + 1);
var S = 2 * Math.PI / l * (g + .5);
if (g < l - 1) {
b.push(new i(e * h(m), e * c(m), .5 * -r));
_.push(2 * g + 2);
b.push(new i(t * h(m), t * c(m), .5 * r));
B.push(2 * g + 3);
...
x.push(B);
v.push(new i(0, 0, 1));
for (w = [], g = 0; g < _.length; g++) w.push(_[_.length - g - 1]);
x.push(w);
o.call(this, b, x, v);
}
}
...
for (var l = g, h = w, c = v, u = m, p = 0, d = t.length; p !== d; p++) {
var y = t[p], f = e[p], b = null;
...
var k = t.radius;
w.lowerBound.set(m.x - k, m.y - k, m.z - k);
w.upperBound.set(m.x + k, m.y + k, m.z + k);
e.getTrianglesInAABB(w, _);
for (var N = E, j = t.radius * t.radius, L = 0; L < _.length; L++) for (var W = 0; W < 3; W++) {
e.getVertex(e.indices[3 * _[L] + W], N);
N.vsub(m, x);
if (x.norm2() <= j) {
b.copy(N);
a.pointToWorldFrame(o, s, b, N);
N.vsub(i, x);
if (p) return !0;
...
for (var d = t.radius, y = !1, f = $, v = tt, m = et, g = null, w = 0, b = 0, x = 0, _ = null, B = 0, S = p.length; B !== S && !1 === y; B++) {
var E = Q;
E.copy(p[B]);
var M = E.norm();
E.normalize();
...
for (var V = u.get(), O = J, k = 0; 2 !== k && !y; k++) for (var N = 0; 2 !== N && !y; N++) for (var j = 0; 2 !== j && !y; j++) {
V.set(0, 0, 0);
k ? V.vadd(p[0], V) : V.vsub(p[0], V);
N ? V.vadd(p[1], V) : V.vsub(p[1], V);
j ? V.vadd(p[2], V) : V.vsub(p[2], V);
o.vadd(V, O);
O.vsub(i, O);
if (O.norm2() < d * d) {
if (c) return !0;
y = !0;
(I = this.createContactEquation(s, a, t, e, l, h)).ri.copy(O);
I.ri.normalize();
I.ni.copy(I.ri);
I.ri.mult(d, I.ri);
I.rj.copy(V);
...
for (k = 0; k !== U && !y; k++) for (N = 0; N !== U && !y; N++) if (k % 3 != N % 3) {
p[N].cross(p[k], L);
L.normalize();
p[k].vadd(p[N], W);
I.copy(i);
...
if (c) return !0;
b = !0;
(q = this.createContactEquation(s, a, t, e, l, h)).ri.copy(w);
q.ri.normalize();
q.ni.copy(q.ri);
q.ri.mult(f, q.ri);
g.vsub(o, q.rj);
...
this.createFrictionEquationsFromContact(q, this.frictionResult);
T = 0;
for (var O = F.length; T !== O; T++) u.release(F[T]);
return;
}
for (T = 0; T !== B.length; T++) {
var k = u.get(), N = u.get();
r.vmult(y[B[(T + 1) % B.length]], k);
r.vmult(y[B[(T + 2) % B.length]], N);
o.vadd(k, k);
o.vadd(N, N);
var j = ot;
N.vsub(k, j);
...
var G = u.get();
W.vsub(i, G);
if (U > 0 && U * U < j.norm2() && G.norm2() < f * f) {
if (c) return !0;
...
this.result.push(q);
this.createFrictionEquationsFromContact(q, this.frictionResult);
for (T = 0, O = F.length; T !== O; T++) u.release(F[T]);
u.release(k);
u.release(N);
u.release(W);
u.release(G);
...
var B = _[0], S = _[1];
if (!(m.z - y > S || m.z + y < B)) for (var E = g; E < w; E++) for (var M = b; M < x; M++) {
var C = !1;
...
var p = e.data, d = t.radius, y = e.elementSize, f = Tt, v = Ft;
...
var _ = x[0], B = x[1];
if (!(v.z - d > B || v.z + d < _)) for (var S = this.result, E = m; E < g; E++) for (var M = w; M < b; M++) {
var C = S.length, A = !1;
e.getConvexTrianglePillar(E, M, !1);
a.pointToWorldFrame(o, r, e.pillarOffset, f);
...
i.to = e;
i.callback = o;
return w.intersectWorld(this, i);
};
...
this.dt = t;
var e, i = this.contacts, o = R, n = P, r = this.numObjects(), s = this.bodies, a = this.solver, l = this.gravity, h = this.doProfiling, c = this.profile, u = p.DYNAMIC, d = this.constraints, y = T, f = (l.norm(), 
l.x), v = l.y, m = l.z, w = 0;
h && (e = performance.now());
for (w = 0; w !== r; w++) if ((O = s[w]).useGravity && O.type === u) {
...
var B = d.length;
for (w = 0; w !== B; w++) if (!(L = d[w]).collideConnected) for (var S = o.length - 1; S >= 0; S -= 1) if (L.bodyA === o[S] && L.bodyB === n[S] || L.bodyB === o[S] && L.bodyA === n[S]) {
o.splice(S, 1);
n.splice(S, 1);
}
...
a.addEquation(L);
O.allowSleep && O.type === p.DYNAMIC && O.sleepState === p.SLEEPING && k.sleepState === p.AWAKE && k.type !== p.STATIC && k.velocity.norm2() + k.angularVelocity.norm2() >= 2 * Math.pow(k.sleepSpeedLimit, 2) && (O._wakeUpAfterNarrowphase = !0);
k.allowSleep && k.type === p.DYNAMIC && k.sleepState === p.SLEEPING && O.sleepState === p.AWAKE && O.type !== p.STATIC && O.velocity.norm2() + O.angularVelocity.norm2() >= 2 * Math.pow(O.sleepSpeedLimit, 2) && (k._wakeUpAfterNarrowphase = !0);
this.collisionMatrix.set(O, k, !0);
if (!this.collisionMatrixPrevious.get(O, k)) {
z.body = k;
z.contact = L;
O.dispatchEvent(z);
z.body = O;
...
this.bodyOverlapKeeper.set(O.id, k.id);
...
for (w = 0; w !== r; w++) if ((O = s[w])._wakeUpAfterNarrowphase) {
O.wakeUp();
O._wakeUpAfterNarrowphase = !1;
}
B = d.length;
for (w = 0; w !== B; w++) {
var L;
...
for (w = 0; w !== r; w++) (O = s[w]).preStep && O.preStep.call(O);
h && (e = performance.now());
...
g.SLEEPING = !0;
for (w = 0; w !== r; w++) if ((O = s[w]).type != p.STATIC && !O.isSleeping()) {
g.SLEEPING = !1;
break;
}
} else g.SLEEPING = !1;
